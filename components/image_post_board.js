...
export default ()=>{
    return <div className={styles.img-board}>
      ...
      <div className={styles.textOnImage}>
        ...
        <div className={styles.text-content}>
          <p>
            ...
            <span className={styles.date}><time class="entry-date published dateCreated" datetime="2022-09-09T19:22:44+00:00">September 9, 2022</time></span>
          </p>
          <p>
    ...
    <div className={styles.b}>
      <div className={styles.c}>
        ...
        <div className={styles.textOnImage}>
          ...
          <div className={styles.text-content}>
            <p>
              <a href="https://livingat300main.ca/category/300-main/" class="cat">300 Main</a>
              <span className={styles.separator}>·</span>
      ...
      <div className={styles.d}>
        <div>
          ...
          <div className={styles.textOnImage}>
            ...
            <div className={styles.text-content}>
              <p>
                <a href="https://livingat300main.ca/category/food-restaurants/" class="cat">Food &amp; Restaurants</a>
                <span className={styles.separator}>·</span>
        ...
        <div>
          ...
          <div className={styles.textOnImage}>
            ...
            <div className={styles.text-content}>
              <p>
                <a href="https://livingat300main.ca/category/food-restaurants/" class="cat">Food &amp; Restaurants</a>
                <a href="https://livingat300main.ca/category/lifestyle/" class="cat">Lifestyle</a>
                <span className={styles.separator}>·</span>
                <span className={styles.date}><time className={styles.time} datetime="2022-09-06T21:27:30+00:00">September 6, 2022</time></span>
              </p>
              <p>
